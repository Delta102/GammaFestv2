            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdBlog = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DescripcionBlog = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PublicacionBlog = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blog_UserPromotor_IdUser",
                        column: x => x.IdUser,
